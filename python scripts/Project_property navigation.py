...
#input_id_start = 15382
#input_id_end = 14061

input_id_start = arcpy.GetParameter(0)
input_id_end = arcpy.GetParameter(1)
...
##############################################################################################
p_x,p_y = getposition_citizen(input_id_start)
l_x,l_y = getposition_citizen(input_id_end)
...
#arcpy.DeleteRows_management("C:/Users/CHAO/Desktop/GIS Project_Chao Zhang/city of vancouver.gdb/navigation_output")