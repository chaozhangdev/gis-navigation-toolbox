...
start_name = arcpy.GetParameter(0)
start_type = arcpy.GetParameter(1)
end_name = arcpy.GetParameter(2)
end_type = arcpy.GetParameter(3)
...
def location_distance_calc(fc,a_name,name):
...
def navigation(path,region,street):
...
filename,attribute_name = destination_info(start_type)
p_x,p_y = location_distance_calc(filename,attribute_name,start_name)

filename,attribute_name = destination_info(end_type)
l_x,l_y = location_distance_calc(filename,attribute_name,end_name)
...
region,region_num = get_region(min_x-300,max_x+300,min_y-300,max_y+300,storedata)
street,street_num = get_street(min_x-300,max_x+300,min_y-300,max_y+300,storedata) 
